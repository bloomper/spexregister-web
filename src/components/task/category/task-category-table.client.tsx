...
import {bulkDeleteAction, deleteAction, getPageAction} from "@/app/(app)/tasks/categories/actions.server";
...
export const columns: ColumnDef<TaskCategory>[] = [
    ...
    },
    {
        ...
        header: ({column}) => {
            ...
            return (
                ...
                >
                    <Translated id="Task.Category.name"/>
                    {isSorted === "desc" ? (
    ...
    },
    {
        ...
        header: ({column}) => {
            ...
            return (
                <Button
                    ...
                    className="-ml-4 h-8 data-[state=open]:bg-accent"
                >
                    <Translated id="Task.Category.actorPresent"/>
                    {isSorted === "desc" ? (
                        <ArrowDown className="ml-2 h-4 w-4"/>
                    ) : isSorted === "asc" ? (
                        <ArrowUp className="ml-2 h-4 w-4"/>
        ...
        cell: ({row}) => {
            const actorPresent = !!row.getValue("actorPresent");
            return (
