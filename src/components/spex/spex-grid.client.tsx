        ...
        <>
            ...
            {noResults ? (
                <div className="col-span-full py-12">
                    <DataEmpty
                        title={isFiltered ? t("Common.noFilterMatchTitle") : t("Common.noDataTitle")}
                    ...
                    >
                        ...
                        {n.posterUrl ? (
                            ...
                            <div className="aspect-video w-full bg-muted flex items-center justify-center border-b">
                                    <span
                                        className="text-muted-foreground text-[10px] uppercase tracking-widest">{t("Common.noDataTitle")}</span>
                            </div>
                        )}
