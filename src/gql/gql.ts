...
const documents: Documents = {
    ...
    "\n    fragment TotalsFields on Totals {\n        spexareCount\n        spexareCountHistory { label count }\n        userCount\n        userCountHistory { label count }\n        spexCount\n        spexCountHistory { label count }\n        spexRevivalCount\n        spexRevivalCountHistory { label count }\n        taskCount\n        taskCountHistory { label count }\n    }\n": types.TotalsFieldsFragmentDoc,
    "\n    fragment AnalyticsFields on Analytics {\n        totals { ...TotalsFields }\n        participation {\n            bySpexYear { ...BucketFields }\n            bySpexCategory { ...BucketFields }\n            topSpex { ...BucketFields }\n            byTaskCategory { ...BucketFields }\n            topTask { ...BucketFields }\n            byVocal { ...BucketFields }\n        }\n        demographics {\n            byCountry { ...BucketFields }\n            byAddressType { ...BucketFields }\n            byMembership { ...BucketFields }\n            byTag { ...BucketFields }\n            byToggle { ...BucketFields }\n            byStatus { ...BucketFields }\n            consentCompletion {\n                key\n                label\n                granted\n                denied\n                missing\n            }\n        }\n        lifecycle {\n            newcomersByYear { ...BucketFields }\n            lastActiveByYear { ...BucketFields }\n            byEngagement { ...BucketFields }\n            byDormancy { ...BucketFields }\n            oneTimers\n            returning\n            veterans\n            neverActive\n        }\n        dataQuality {\n            total\n            issues { ...BucketFields }\n            complete\n        }\n        operations {\n            usersByState { ...BucketFields }\n            usersWithoutSpexare\n            spexareWithoutUser\n            revisionsByMonth { ...BucketFields }\n            revisionsBySource { ...BucketFields }\n            topEditors { ...BucketFields }\n        }\n    }\n": types.AnalyticsFieldsFragmentDoc,
    "\n    query Analytics {\n        analytics {\n            ...AnalyticsFields\n        }\n    }\n": types.AnalyticsDocument,
    "\n    query AnalyticsSummary {\n        analytics {\n            totals { ...TotalsFields }\n            participation {\n                bySpexYear { ...BucketFields }\n            }\n            dataQuality {\n                issues { ...BucketFields }\n            }\n        }\n    }\n": types.AnalyticsSummaryDocument,
    "\n    query revisions($type: AuditedType!, $id: ID!) {\n        revisions(type: $type, id: $id) {\n            revision\n            type\n            entityId\n            entityLabel\n            revisionType\n            modifiedAt\n            modifiedBy\n            changes {\n                field\n                oldValue\n                newValue\n                binary\n                type\n                entityId\n            }\n        }\n    }\n": types.RevisionsDocument,
    "\n    query relatedRevisions($type: AuditedType!, $id: ID!, $relatedType: AuditedType!) {\n        relatedRevisions(type: $type, id: $id, relatedType: $relatedType) {\n            revision\n            type\n            entityId\n            entityLabel\n            revisionType\n            modifiedAt\n            modifiedBy\n            changes {\n                field\n                oldValue\n                newValue\n                binary\n                type\n                entityId\n            }\n        }\n    }\n": types.RelatedRevisionsDocument,
    "\n    query revisionFeedPaged($first: Int, $after: String, $last: Int, $before: String, $type: AuditedType, $modifiedBy: [String!], $sources: [AuditSource!], $from: Date, $to: Date, $sinceInDays: Int) {\n        revisionFeedPaged(first: $first, after: $after, last: $last, before: $before, type: $type, modifiedBy: $modifiedBy, sources: $sources, from: $from, to: $to, sinceInDays: $sinceInDays) {\n            edges {\n                cursor\n                node {\n                    revision\n                    modifiedAt\n                    modifiedBy\n                    types\n                    source\n                    operation\n                    comment\n                }\n            }\n            pageInfo {\n                hasPreviousPage\n                hasNextPage\n                startCursor\n                endCursor\n            }\n            totalCount\n        }\n    }\n": types.RevisionFeedPagedDocument,
    "\n    query revisionDetail($revision: Long!) {\n        revisionDetail(revision: $revision) {\n            revision\n            modifiedAt\n            modifiedBy\n            source\n            operation\n            comment\n            entities {\n                type\n                entityId\n                entityLabel\n                revisionType\n                changes {\n                    field\n                    oldValue\n                    newValue\n                    binary\n                    type\n                    entityId\n                }\n                target {\n                    type\n                    id\n                    label\n                }\n            }\n        }\n    }\n": types.RevisionDetailDocument,
    "\n    query revisionAuthors {\n        revisionAuthors\n    }\n": types.RevisionAuthorsDocument,
    "\n    query restorePreview($type: AuditedType!, $id: ID!, $revision: Long!, $cascade: Boolean) {\n        restorePreview(type: $type, id: $id, revision: $revision, cascade: $cascade) {\n            entries {\n                type\n                id\n                action\n                changes {\n                    field\n                    oldValue\n                    newValue\n                    binary\n                }\n            }\n            warnings {\n                code\n                message\n                previousId\n                newId\n            }\n        }\n    }\n": types.RestorePreviewDocument,
    "\n    mutation restore($type: AuditedType!, $id: ID!, $revision: Long!, $cascade: Boolean) {\n        restore(type: $type, id: $id, revision: $revision, cascade: $cascade) {\n            revision\n            updated\n            created\n            deleted\n            warnings {\n                code\n                message\n                previousId\n                newId\n            }\n        }\n    }\n": types.RestoreDocument,
    "\n    fragment GraphNodeFields on GraphNode {\n        id\n        type\n        label\n        sublabel\n        imageUrl\n        revival\n        entityId\n    }\n": types.GraphNodeFieldsFragmentDoc,
    "\n    query GraphSearch($q: String!, $first: Int!) {\n        graphSearch(q: $q, first: $first) {\n            ...GraphNodeFields\n        }\n    }\n": types.GraphSearchDocument,
    "\n    query GraphNeighbourhood($type: GraphNodeType!, $id: ID!, $first: Int!) {\n        graphNeighbourhood(type: $type, id: $id, first: $first) {\n            origin { ...GraphNodeFields }\n            groups {\n                type\n                totalCount\n                nodes { ...GraphNodeFields }\n                edges { id source target type label }\n            }\n        }\n    }\n": types.GraphNeighbourhoodDocument,
    "\n    query GraphNeighboursPaged($type: GraphNodeType!, $id: ID!, $edge: GraphEdgeType!, $first: Int, $after: String) {\n        graphNeighboursPaged(type: $type, id: $id, edge: $edge, first: $first, after: $after) {\n            edges { cursor node { ...GraphNodeFields } }\n            pageInfo { hasNextPage endCursor }\n            totalCount\n        }\n    }\n": types.GraphNeighboursPagedDocument,
