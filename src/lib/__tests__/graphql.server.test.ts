...
describe('collectAllPages', () => {
    it('walks every page until hasNextPage is false and forwards the cursor', async () => {
        const pages: Record<string, CursorPage<{id: string}>> = {
            'null': {items: [{id: '1'}, {id: '2'}], pageInfo: {hasNextPage: true, hasPreviousPage: false, startCursor: null, endCursor: 'c2'}},
            'c2': {items: [{id: '3'}], pageInfo: {hasNextPage: false, hasPreviousPage: false, startCursor: null, endCursor: null}},
        };
